...
$$
obj=\sum_{i=1}^{n} l\left(y_{i}, \tilde{y}_{i}^{k}\left(x_{i}\right)\right)+\sum_{k=1}^{K}\Omega\left(f_{k}\right)=\sum_{i=1}^{n} l\left(y_{i}, \tilde{y}_{i}^{k-1}+f_{k}\left(x_{i}\right)\right)+\sum_{k=1}^{K-1}\Omega\left(f_{k}\right)+\Omega(f(k))
$$
